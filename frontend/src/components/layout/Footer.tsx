      ...
      <div className="mx-auto max-w-[1200px] px-6">
        <div className="grid grid-cols-1 md:grid-cols-[2fr_1fr_1fr] gap-12 mb-12">
          <div>
            ...
            <p className="mt-3 text-[13px] text-[#64748b]">A product by <a href="https://boltedge.co" className="text-[#d97706] hover:underline">BoltEdge</a></p>
          </div>
          <div>
            <h4 className="text-sm font-semibold text-white mb-4">Products</h4>
            <a href="https://easm.boltedge.co" className="block text-sm text-[#94a3b8] hover:text-white mb-2.5">BoltEdge EASM</a>
            <a href="https://boltedge.co/#services" className="block text-sm text-[#94a3b8] hover:text-white mb-2.5">Security Services</a>
          ...
          <div>
            ...
            <a href="mailto:support@boltedge.co" className="block text-sm text-[#94a3b8] hover:text-white mb-2.5">support@boltedge.co</a>
        ...
        <div className="flex justify-between items-center pt-6 border-t border-white/[0.06] text-[13px] text-[#64748b]">
          <span>&copy; 2026 BoltEdge. All rights reserved.</span>
